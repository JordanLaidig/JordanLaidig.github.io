		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-between">
				<div class="home-banner-content col-lg-6 col-md-6">
					<h1>
						FFXIV Gear <br>Calculator
					</h1>
					<p>Find your gear fast!</p>
				...
				<div class="banner-img col-lg-4 col-md-6">
					<img class="img-fluid" src="img/Screenshot_1586911937.png" alt="">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						...
						<p> Search through hundreds of pieces of gear that match your needs, and even find out some pieces that might look great for you glamour.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						...
						<p> Some basic screens that you might see in the app.
						</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="owl-carousel owl-screenshot">
					...
					<div class="single-screenshot">
						<img class="img-fluid" src="img/Screenshot_1586912304.png" alt="">
					</div>
					<div class="single-screenshot">
						<img class="img-fluid" src="img/Screenshot_1586912312.png" alt="">
					</div>
				</div>
			</div>
		</div>
